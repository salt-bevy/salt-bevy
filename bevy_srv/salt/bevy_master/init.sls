...
{{ salt['config.get']('salt_config_directory') }}/cloud.providers:
  file.prepend:
    ...
    - text: |
        # - management by Salt -
        #
        # This Salt master is, itself, provisioned using Salt.
        # For best results, do not edit this file.
        # All significant settings should be done in the cloud.providers.d directory.
        # Keep this file around for the examples below.
        #  v  v  v
